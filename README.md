...
### 1. Предобработка данных: [Исследование надежности заёмщиков](https://github.com/davidbalya/final_test/blob/main/Проект_01_Исследование_надёжности_заёмщиков.ipynb)
